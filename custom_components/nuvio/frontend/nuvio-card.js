class NuvioCard extends HTMLElement {
  ...
  header(){
    ...
    var remote=this._config.show_remote===false?"":'<button class="ib" id="remoteToggle" title="Remote"><ha-icon icon="mdi:remote-tv"></ha-icon></button>';
...
console.info("NUVIO-CARD v0.4.6");
