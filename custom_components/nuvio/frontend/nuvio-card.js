class NuvioCard extends HTMLElement {
  ...
  remotePanel(){
    if(this._config.show_remote===false)return "";
    return '<aside class="remote-panel">'+
      '<div class="remote-title">Remote</div>'+
      '<button class="remote-wide" data-remote-key="wake" title="Wake / dismiss screensaver"><ha-icon icon="mdi:television"></ha-icon><span>Wake</span></button>'+
      '<div class="dpad">'+
        '<span></span><button data-remote-key="up" title="Up"><ha-icon icon="mdi:chevron-up"></ha-icon></button><span></span>'+
        '<button data-remote-key="left" title="Left"><ha-icon icon="mdi:chevron-left"></ha-icon></button><button class="remote-ok" data-remote-key="ok" title="OK">OK</button><button data-remote-key="right" title="Right"><ha-icon icon="mdi:chevron-right"></ha-icon></button>'+
        '<span></span><button data-remote-key="down" title="Down"><ha-icon icon="mdi:chevron-down"></ha-icon></button><span></span>'+
      '</div>'+
      '<div class="remote-bottom">'+
        '<button data-remote-key="back" title="Back"><ha-icon icon="mdi:arrow-left"></ha-icon></button>'+
        '<button data-remote-key="home" title="Home"><ha-icon icon="mdi:home"></ha-icon></button>'+
      '</div>'+
    '</aside>';
  }
  detailsView(){
  ...
  render(){
    ...
    var content=this._config.show_remote===false
      ? body
      : '<div class="nuvio-layout remote-'+side+'>'+this.remotePanel()+'<main class="nuvio-main">'+body+'</main></div>';
...
console.info("NUVIO-CARD v0.4.4");
