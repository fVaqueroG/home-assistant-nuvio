...
class NuvioCard extends HTMLElement {
  ...
  if (this._remoteExpanded && portal) {
    ...
    nuvioThemeStyle(portal,mode,darkMode);
...
async choosePlayer(player){
  ...
  var home='<button class="ib toolbar-btn '+(onHome?"toolbar-active":"")+'" id="homeTop" title="Home" aria-label="Home"><ha-icon icon="mdi:home"></ha-icon></button>';
    return '<div class="header"><div class="header-title"><img class="nuvio-wordmark" src="/nuvio/assets/wordmark.png?v=0.4.97" alt="Nuvio" decoding="async" style="display:none;height:38px;max-width:150px;width:auto;object-fit:contain"><h2 class="nuvio-wordmark-fallback">'+this.esc(this._config.title||"Nuvio")+'</h2><span class="card-version">v0.4.97</span></div><div class="tools">'+search+this.roomSelect()+'<label class="toolbar-player" title="Select media player"><ha-icon icon="mdi:television" aria-hidden="true"></ha-icon>'+this.playerSelect()+'</label>'+
      home+
    ...
    portal.innerHTML=`
      <style>
        ...
        #nuvio-remote-portal .nuvio-ring-ok{
          ...
          background:var(--nuvio-primary,#6157fb);border:0;color:white;font-size:11px;font-weight:800;
...
console.info("NUVIO-CARD v0.4.97");
