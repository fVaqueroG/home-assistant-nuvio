class NuvioCard extends HTMLElement {
  ...
  header(){
    ...
    return '<div class="header"><div class="header-title"><h2>'+this.esc(this._config.title||"Nuvio")+'</h2><span class="card-version">v0.4.58</span></div><div class="tools">'+search+
      home+
...
console.info("NUVIO-CARD v0.4.58");
