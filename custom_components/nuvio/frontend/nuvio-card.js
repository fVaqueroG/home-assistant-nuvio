...
async choosePlayer(player){
  ...
  catalogView(){
    ...
    return '<div class="catalog-view"><div class="catalog-fixed"><div class="top catalog-top"><button class="back" id="back">← Home</button><h3>'+this.esc(title)+addon+'</h3></div>'+tabs+'<div class="nuvio-catalog-quick-nav"><button type="button" class="nuvio-scroll-start" title="Back to beginning" aria-label="Back to beginning">↑ Beginning</button></div></div><div class="catalog-scroll">'+content+more+'</div></div>';
  }
  ...
  header(){
    ...
    var beginning=this._view==="sources"
  ...
  render(){
    ...
    if(this._view==="home")body='<div class="nuvio-home-toolbar"><button type="button" class="nuvio-scroll-start" title="Back to beginning" aria-label="Back to beginning">↑ Beginning</button></div><div class="nuvio-home-scroll">'+body+'</div>';
