      ...
      var rows=items.map(({stream:s,index:n})=>{
        ...
        return '<div class="source-row">'+
          ...
          '<div class="source-actions">'+
            (s.direct?'<button class="action primary playsource" data-source-index="'+n+'">▶ Play direct</button>':'<span class="resolver">'+this.esc(unavailable)+'</span>')+
          '</div>'+
        '</div>';
      }).join("");
...
console.info("NUVIO-CARD v0.3.8");
