class NuvioCard extends HTMLElement {
  ...
  remotePanel(){
    ...
    return '<div class="remote-dock remote-dock-'+side+' open">'+
  ...
  render(){
    ...
    var content=this._config.show_remote===false
      ? body
      : '<div class="nuvio-layout '+(this._remoteExpanded?"remote-open":"")+'">'+this.remotePanel()+'<main class="nuvio-main">'+body+'</main></div>';
...
console.info("NUVIO-CARD v0.4.8");
