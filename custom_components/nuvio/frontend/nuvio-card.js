class NuvioCard extends HTMLElement {
  ...
  remotePanel(){
    ...
    var open=this._remoteExpanded;
    return '<div class="remote-dock remote-dock-'+side+' '+(open?"open":"closed")+'">'+
      '<button class="remote-toggle" id="remoteToggle" title="'+(open?"Hide remote":"Show remote")+'"><ha-icon icon="mdi:remote-tv"></ha-icon></button>'+
      (open?'<div class="remote-shell">'+
...
console.info("NUVIO-CARD v0.4.5");
