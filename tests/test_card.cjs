...
assert.deepEqual([...localAssets.readFileSync('custom_components/nuvio/frontend/assets/wordapp_logo_mark.png').subarray(0,8)],[137,80,78,71,13,10,26,10]);
assert.deepEqual([...localAssets.readFileSync('custom_components/nuvio/frontend/assets/app_logo_mark.png').subarray(0,8)],[137,80,78,71,13,10,26,10]);
...
assert.equal(launcher.shadowRoot.querySelector('.launcher-logo').getAttribute('src'),'/nuvio/assets/wordapp_logo_mark.png?v=0.4.75');
...
assert.equal(launcher.shadowRoot.querySelector('.launcher-mark').getAttribute('src'),'/nuvio/assets/app_logo_app_logo_mark.png?v=0.4.75');
