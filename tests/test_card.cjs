...
assert.equal(launcher.shadowRoot.querySelector('.launcher-logo').getAttribute('src'),'/nuvio/assets/wordmark.png?v=0.4.98');
...
assert.equal(launcher.shadowRoot.querySelector('.launcher-vertical-logo').getAttribute('src'),'/nuvio/assets/vertical.png?v=0.4.98');
...
assert.equal(launcher.getCardSize(),2);
assert.equal(launcher.shadowRoot.querySelector('.launcher-mark').getAttribute('src'),'/nuvio/assets/icon-only.png?v=0.4.98');
assert.equal(launcher.shadowRoot.querySelector('.launcher-logo'),null);
assert.equal(launcher.shadowRoot.querySelector('.launcher-visual ha-icon'),null);
assert.equal(launcher.shadowRoot.querySelector('.launcher-caption').style.display,'none');
